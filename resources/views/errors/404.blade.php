...
<head>
    ...
    <link href="{{asset('')}}metronic_admin/pages/css/error.min.css" rel="stylesheet" type="text/css"/>
...
<div class="page-inner">
    <img src="{{asset('')}}metronic_admin/pages/media/pages/earth.jpg" class="img-responsive" alt=""></div>
<div class="container error-404">
    <h1>404</h1>
    <h2>Houston, we have a problem.</h2>
    <p> Actually, the page you are looking for does not exist. </p>
    <p>
        <a href="{{back()->getTargetUrl()}}" class="btn red btn-outline"> Return home </a>
        <br></p>
</div>
<!--[if lt IE 9]>
