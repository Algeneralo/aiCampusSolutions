...
<head>
    ...
    <link href="{{asset('')}}metronic_admin/global/plugins/select2/css/select2.min.css" rel="stylesheet"
          type="text/css"/>
    <link href="{{asset('')}}metronic_admin/global/plugins/select2/css/select2-bootstrap.min.css" rel="stylesheet"
          type="text/css"/>
    ...
    <link href="{{asset('')}}metronic_admin/pages/css/login.min.css" rel="stylesheet" type="text/css"/>
...
<!-- END CORE PLUGINS -->
<!-- BEGIN PAGE LEVEL PLUGINS -->
<script src="{{asset('')}}metronic_admin/global/plugins/jquery-validation/js/jquery.validate.min.js"
        type="text/javascript"></script>
<script src="{{asset('')}}metronic_admin/global/plugins/jquery-validation/js/additional-methods.min.js"
        type="text/javascript"></script>
<script src="{{asset('')}}metronic_admin/global/plugins/select2/js/select2.full.min.js" type="text/javascript"></script>
<!-- END PAGE LEVEL PLUGINS -->
<!-- BEGIN THEME GLOBAL SCRIPTS -->
<script src="{{asset('')}}metronic_admin/global/scripts/app.min.js" type="text/javascript"></script>
<!-- END THEME GLOBAL SCRIPTS -->
<!-- BEGIN PAGE LEVEL SCRIPTS -->
<script src="{{asset('')}}metronic_admin/pages/scripts/login.min.js" type="text/javascript"></script>
