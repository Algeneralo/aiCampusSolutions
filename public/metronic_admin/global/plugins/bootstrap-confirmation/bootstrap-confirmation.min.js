...
!function (a) {
    ...
    var c = function (b, c) {
        ...
        }), this.$element.on("confirmed.bs.confirmation", function (b) {
    ...
    c.DEFAULTS = a.extend({}, a.fn.popover.Constructor.DEFAULTS, {
        ...
        c.find(".popover-title")[d.html ? "html" : "text"](this.getTitle()), c.find('[data-apply="confirmation"]').addClass(d.btnOkClass).html(d.btnOkLabel).prepend(a("<i></i>").addClass(d.btnOkIcon), " ").off("click").one("click", function (a) {
            b.getOnConfirm.call(b).call(b.$element), b.$element.trigger("confirmed.bs.confirmation"), b.$element.confirmation("hide")
        }), d.href && "#" != d.href && c.find('[data-apply="confirmation"]').attr({
            href: d.href,
            target: d.target
            ...
            b.getOnCancel.call(b).call(b.$element), b.$element.trigger("canceled.bs.confirmation"), b.$element.confirmation("hide")
